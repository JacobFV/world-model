...
Each acquisition retains publisher/source metadata, receipt and immutable input hash.
Derived datasets retain those input references recursively. Rights summaries propagate
