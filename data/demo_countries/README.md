...
Local implementation: [pipeline.py](pipeline.py). Stages: **parsed → normalized**; default output: `normalized`. The [dataset.json](dataset.json) declaration pins source configuration, parameters, dependencies and validation.
