# fec_individual_contributions_2022
...
- `https://www.fec.gov/files/bulk-downloads/2022/indiv22.zip` (5,216,211,173 bytes; 2022 two-year cycle).
...
python3 -m worldmodel acquire fec_individual_contributions_2022 --allow-network
WORLD_MODEL_RAW_VERIFY=size python3 -m worldmodel run fec_individual_contributions_2022
python3 -m worldmodel verify fec_individual_contributions_2022
python3 -m worldmodel use-policy --dataset fec_individual_contributions_2022   # what the run will write, and why
```
