...
Commodity Flow Survey and Freight Analysis Framework
...
Preserve commodity revision, mode, geographic zones, value/tonnage units and modeled versus surveyed status. No acquired normalization path is available; the local pipeline fails explicitly instead of fabricating records.
