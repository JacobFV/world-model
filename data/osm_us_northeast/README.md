...
OpenStreetMap network topology for the Geofabrik **US Northeast** extract: Connecticut, Maine, Massachusetts, New Hampshire, New Jersey, New York, Pennsylvania, Rhode Island, Vermont.
...
- File: `https://download.geofabrik.de/north-america/us-northeast-260914.osm.pbf` (1,798,185,986 bytes, md5 `a22a29b19fa205091a6b61246cb094ee`, replication snapshot 2026-09-14).
...
```sh
wm budget
wm acquire osm_us_northeast --allow-network
WORLD_MODEL_RAW_VERIFY=size wm run osm_us_northeast
wm verify osm_us_northeast && wm verify osm_us_northeast/parsed
python3 -m unittest data/osm_us_northeast/tests/test_pipeline.py
```
