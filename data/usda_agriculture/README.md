...
Select survey and aggregation level; retain suppressed values, units and geographic vintage. No acquired normalization path is available; the local pipeline fails explicitly instead of fabricating records.
